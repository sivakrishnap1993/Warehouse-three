...
//it is Spring WEB MVC AppConfig
@EnableWebMvc
//enable commit/RollBack
...
public class AppConfig implements WebMvcConfigurer {
	...
	public LocalSessionFactoryBean sfObj() {
		...
		sf.setAnnotatedClasses(Employee.class, Uom.class, ShipmentType.class, Purchase.class, OrderMethod.class,
				Admin.class, WhUserType.class, User.class, Document.class,Item.class); // Model class names
		return sf;
	}
	...
	// 6.Converted To Multi part Resolver
	@Bean
